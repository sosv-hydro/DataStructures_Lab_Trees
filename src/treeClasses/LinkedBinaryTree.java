...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> implements Cloneable {
	 ...
	 *             throws this exception if the tree is not empty. Such operation is
	 *             not valid on a non empty tree.
	 */
	 ...
	 * 
	 * @param p
	 *            The position whose left child will be the new position containing
	 *            the specified element.
	 * @param e
	 *            The new element to be placed in that new position.
	 * @return The new position that is created.
	 * @throws IllegalArgumentException
	 *             If p is not valid pas per the validate method, of if p already
	 *             has a left child in the tree.
	 */
	 ...
	 * 
	 * @param p
	 *            The external node to which the specified subtrees will be
	 *            attached.
	 * @param t1
	 *            The binary tree to be inserted as the left subtree of p.
	 * @param t2
	 *            The binary tree to be inserted as the right subtree of p.
	 * @throws IllegalArgumentException
	 *             if p is not a valid position or if p is not an external method.
	 */
	 ...
	 * 
	 * @param p
	 *            The position to be removed (or corresponding to the node to be
	 *            removed.
	 * @return The element at the removed position.
	 * @throws IllegalArgumentException
	 *             if p is not a valid position or if p has two children. This
	 *             remove is not valid for nodes having two children.
	 */
